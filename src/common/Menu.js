...
export default class Menu extends React.Component {
    ...
    while (target.className !== 'menuContainer') {
      if (target.className === 'liItem') {
        if(target.parentNode.children[0] === target) {
          if (document.location.href.substr(21) === "/") return;
        ...
        if(target.parentNode.children[1] === target) {
          if (document.location.href.substr(21) === "/profile") return;
        ...
        if(target.parentNode.children[2] === target) {
          if (document.location.href.substr(21) === "/test-set") return;
        ...
        if(target.parentNode.children[3] === target) {
          if (document.location.href.substr(21) === "/stats") return;
        ...
        if(target.parentNode.children[4] === target) {
          if (document.location.href.substr(21) === "/about-us") return;
  ...
  render() {      
    if (this.state.isOpened === false) return this.menuIcon;

    if (this.state.moveTo === 'home') return <Redirect to="/" />;

    if (this.state.moveTo === 'profile') return <Redirect to="/profile" />;

    if (this.state.moveTo === 'test-set') return <Redirect to="/test-set" />;

    if (this.state.moveTo === 'stats') return <Redirect to="/stats" />;

    if (this.state.moveTo === 'about-us') return <Redirect to="/about-us" />;
